...
# Variáveis
RESOURCE_GROUP="rg-firewatch"
LOCATION="eastus2"
VM_NAME="vm-firewatch"
...
# Abrir porta 3306 para o MySql
echo "Abrindo porta 3306 para MySql"
az vm open-port --resource-group rg-firewatch --name vm-firewatch --port 3306 --priority 1002
